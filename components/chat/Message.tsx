        ...
        <div ref={ref} className={cn('flex items-end', { 'justify-end': message.isUserMessage })}>
            ...
            <div className={cn('flex flex-col space-y-2 text-base max-w-md mx-2', {
                ...
                <div className={cn('px-4 py-2 rounded-lg inline-block', {
                    ...
                    {typeof message.text === 'string' ? <ReactMarkdown className={cn('prose', { 'text-zinc-50': message.isUserMessage })}>{message.text}</ReactMarkdown> : message.text}
                    {message.id !== 'loading-message' ? (
                        <div className={cn('text-xs select-none mt-2 w-full text-right', { 'text-zinc-500': !message.isUserMessage, 'text-rose -300': message.isUserMessage })}>
